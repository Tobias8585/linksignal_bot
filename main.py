...
def check_all_symbols():
    ...
    "TURBOUSDT", "MOGUSDT", "DYMUSDT", "PORTALUSDT", "1000SATSUSDT", "LINAUSDT", "IDEXUSDT", "SPELLUSDT", "FETUSDT",
    "LITUSDT", "CVCUSDT", "COTIUSDT", "REEFUSDT", "LQTYUSDT", "NMRUSDT", "RSRUSDT", "MTLUSDT", "PHBUSDT", "GALUSDT",
    "WNXMUSDT", "BONDUSDT", "FLOKIUSDT", "ALPACAUSDT", "XVGUSDT", "BTSUSDT", "SFPUSDT", "VTHOUSDT", "TRACUSDT", "ANTUSDT",
    "POWRUSDT", "USTCUSDT", "STRAXUSDT", "MDTUSDT", "DGBUSDT", "BADGERUSDT", "AUDIOUSDT", "XECUSDT", "VOXELUSDT", "TUSDT",
    "LPTUSDT", "MLNUSDT", "TVKUSDT", "UNFIUSDT", "FORTHUSDT", "RUNEUSDT", "ERNUSDT", "FARMUSDT", "DUSKUSDT", "XVSUSDT",
    "SUNUSDT", "BETAUSDT", "ASTRUSDT", "AERGOUSDT", "GHSTUSDT", "BAKEUSDT", "QUICKUSDT", "ALCXUSDT", "JASMYUSDT", "REIUSDT",
    "PUNDIXUSDT", "OMGUSDT", "KLAYUSDT", "OXTUSDT", "KEYUSDT", "BONDUSDT", "CKBUSDT", "ACMUSDT", "WAVESUSDT", "XRP3LUSDT"
